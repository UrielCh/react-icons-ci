...
/**
 * MedicalClipboard icon from Circum Icons
 * @module
 */
export function CiMedicalClipboard(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default CiMedicalClipboard;
